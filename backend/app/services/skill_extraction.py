...
SKILL_ALIASES = {
    ...
    "backup and recovery": {"backup and recovery", "backup recovery", "database backup", "restore"},
    ...
    "swift": {"swift"},
    "decentralized applications": {"decentralized applications", "decentralized apps", "dapps", "dapp"},
    "security auditing": {"security auditing", "security audit", "smart contract audit"},
    ...
    "mobile testing": {"mobile testing", "mobile test automation"},
    "mobile ui": {"mobile ui", "mobile ux", "mobile interface"},
    "app store deployment": {"app store deployment", "play store deployment"},
    "offline storage": {"offline storage", "local storage"},
    "git": {"git", "github", "gitlab"},
    "bug tracking": {"bug tracking", "jira", "bug reports", "defect tracking"},
    "quality assurance": {"quality assurance", "qa"},
    "token standards": {"token standards", "erc-20", "erc20", "erc-721", "erc721", "nft standard"},
}
